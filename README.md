...
**Available Now (Click links to verify):**
...
1. **Architecture Decisions** → Expand [ADR table below](#architectural-decision-records) for 24 documented decisions with rationale
